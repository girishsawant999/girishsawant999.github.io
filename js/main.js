...
$("#showAll").on("click", function () {
  var articles = $(".timeline-centered article");
  articles.each(function (index) {
    $(this).hasClass("extraProjects") && $(this).toggleClass("hidden");
  });
  ...
  if (Btn.text().includes("Show")) {
    ...
    $("html, body").animate(
      {
        scrollTop: $(".colorlib-projects").offset().top,
      },
      500
    );
  }
...
new hoverEffect({
  parent: document.querySelector(".author-img"),
  intensity: 0.5,
  image1: "/images/about.jpg",
  image2: "/images/about_1.jpg",
  angle: Math.PI / 6,
